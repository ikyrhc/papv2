		...
		<table width="900" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#fdb79b"
			...
			<thead>
				<tr>
					...
					style="border-top-right-radius: 10px; border-top-left-radius: 10px;">Alta Domicilios Frecuentes</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td width="150" nowrap="nowrap">
						<input type="text" name="id_int" size="20" maxlength="20" placeholder="Identificador Unico" 
						 onkeyup="this.value=this.value.toUpperCase()" autofocus /></td>
					<td width="150" nowrap="nowrap" class="Etiqueta">Contraseña :</td>
					<td width="150" nowrap="nowrap">
						<input class="Contra" type="text" name="contrasena" size="20" maxlength="15" /></td>
					<td width="150" nowrap="nowrap" class="Etiqueta">Id Subcliente :</td>
					<td width="150" nowrap="nowrap">
						<input type="text" name="sc_prin" id="sc_prin" size="20" maxlength="20" placeholder="ID SubCliente" /></td>
				</tr>
				<tr>		
					...
					<td width="150" nowrap="nowrap">
						...
						<input type="text" name="fe_reg" id="fe_reg" size="16" placeholder="Fecha Registro" readonly="readonly"
						tabindex="-1" /></td>
					<td width="150" nowrap="nowrap" class="Etiqueta">Fecha Alta :</td>
					<td width="150" nowrap="nowrap" ><input type="text" name="f_reg" size="20" readonly="readonly" tabindex="-1" /></td>
					<td width="150" nowrap="nowrap" class="Etiqueta">Estatus :</td>
					<td width="150" nowrap="nowrap" ><input type="text" name="estatus" id="estatus" size="20" value="ACTIVO" readonly="readonly" tabindex="-1"/>
				</tr>
                <tr>
                	<td colspan="6">&nbsp;</td>	
                </tr>
				<tr>
					...
					<td width="150" nowrap="nowrap">
						<input type="text" name="rfc" size="15" maxlength="13" onkeyup="this.value=this.value.toUpperCase()"
						placeholder="RFC del Cliente"/></td>
					<td width="150" nowrap="nowrap" class="Etiqueta">Razón Social :</td>
					<td width="450" nowrap="nowrap" colspan="3">
						<input type="text" name="raz_soc" size="71" 
						onkeyup="this.value=this.value.toUpperCase()" placeholder="Razon Social del Cliente Completa"/></td>
				</tr>
				<tr>
					<td width="150" nowrap="nowrap" class="Etiqueta">Domicilio :</td>
					<td width="450" nowrap="nowrap" colspan="5">
						<input type="text" name="dom" size="122" onkeyup="this.value=this.value.toUpperCase()"
						placeholder="Dirección del Cliente"/></td>
				</tr>
				<tr>
					<td width="150" nowrap="nowrap" class="Etiqueta">No. Ext. / Int. :</td>
              	...
              	<tr>
                	...
                	<td width="150" nowrap="nowrap" ><input type="text" name="tel_of_2" size="20" placeholder="55 5555 5555"/></td>
                  	<td width="150" nowrap="nowrap" class="Etiqueta">Fax :</td>
                  	<td width="150" nowrap="nowrap" ><input type="text" name="fax" size="20" placeholder="55 5555 5555"/>
              	</tr>
                <tr>
                    <td width="150" nowrap="nowrap" class="Etiqueta">Contacto :</td>
                    <td width="750" nowrap="nowrap" colspan="5">
                    	<input type="text" name="p_conta" size="122" maxlength="50" onkeyup="this.value=this.value.toUpperCase()" 
                    	placeholder="Nombre del Contacto"/></td>
                </tr>
                <tr>
                    <td width="150" nowrap="nowrap" class="Etiqueta">E-Mail Contacto :</td>
                    <td width="750" nowrap="nowrap" colspan="5">
                    	<input type="text" name="p_email" size="122" maxlength="50" placeholder="nombre@ejempo.com.mx"/>
                    </td>

                </tr>
                <tr>
                    <td width="150" nowrap="nowrap" class="Etiqueta">E-Mail Empresa :</td>
                  	<td width="750" nowrap="nowrap" colspan="5">
                        <input type="text" name="email" size="122" maxlength="50" placeholder="nombre@exemplo.com.mx"/></td>
                </tr>
                <tr>    
                    <td width="150" nowrap="nowrap" class="Etiqueta">Pagina Web :</td>
                    <td width="450" nowrap="nowrap" colspan="3">
           		  		<input type="text" name="http" size="70" maxlength="50" placeholder="http://www.ejemplo.com.mx" /></td>
					<td width="150" nowrap="nowrap" class="Etiqueta">Ubicación :</td>					
					<td width="150" nowrap="nowrap" align="center">
						<select class="Captura" name="ubica" id="ubica">
				...
				<tr>
					<td width="150" nowrap="nowrap" class="Etiqueta">Observaciones :</td>
					<td width="750" nowrap="nowrap" colspan="5">
						<textarea name="observaciones" cols="121" rows="4"
