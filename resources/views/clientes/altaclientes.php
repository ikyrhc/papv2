...
<body>
	<form action="altaclientes_submit" method="get" accept-charset="utf-8">
		<table width="1200" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#fdb79b"
			...
			<tbody>
				...
				<tr>
              	...
              	<tr>
                    ...
                    <td><input type="text" name="tel_of" size="20" placeholder="55 5555 5555"/></td>
                	<td class="Etiqueta">Tel. Of. 2 :</td>
                	<td><input type="text" name="tel_of_2" size="20" placeholder="55 5555 5555"/></td>
                  	<td class="Etiqueta">Fax :</td>
                  	<td><input type="text" name="fax" size="20" placeholder="55 5555 5555"/>
              	</tr>
                <tr>
                    ...
                    <td colspan="3">
                    	<input type="text" name="p_email" size="71" placeholder="nombre@ejempo.com.mx"/>
                    </td>
                ...
                <tr>
                    <td class="Etiqueta">E-Mail Empresa :</td>
                  	<td width="400" colspan="3">
                        <input type="text" name="email" size="71" placeholder="nombre@exemplo.com.mx"/></td>
                    <td class="Etiqueta">Pagina Web :</td>
                    <td width="400"  colspan="3">
           		  		<input type="text" name="http" size="71" placeholder="http://ejemplo.com.mx" /></td>
				</tr>
				<tr>
					<td colspan="8">&nbsp;</td>
				</tr>
