...
class CreateTbClientesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_clientes', function (Blueprint $table) {
            ...
            $table->string('nom_com')->comment('Nombre Comercial');
            ...
            $table->date('fe_reg')->comment('Fecha de Alta al sistema');
            ...
            $table->string('p_conta2', 50)->comment('Persona de Contacto 2');
            $table->string('p_email2', 50)->comment('eMail de Contacto de la Empresa 2');
